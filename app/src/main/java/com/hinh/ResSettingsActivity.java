...
public class ResSettingsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.res_activity_settings);
		...
		btnSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!googleUsername.equalsIgnoreCase(pref.getGoogleUserName())
					...
					Intent i = new Intent(ResSettingsActivity.this,
							ResSplashActivity.class);
